...
public class DeleteClientActivityTest {
    ...
    public void handleRequest_withValidRequest_deletesClient() {
        ...
        doNothing().when(clientDao).deleteClient("user@example.com", "validClientId");
    ...
    public void handleRequest_withNonExistentClient_throwsClientNotFoundException() {
        ...
        doThrow(new ClientNotFoundException("Client not found with clientId: nonExistentClientId"))
                .when(clientDao).deleteClient("user@example.com", "nonExistentClientId");
        ...
        verify(clientDao).deleteClient("user@example.com", "nonExistentClientId");
    }
}
