...
export default class ClientKeeperClient extends BindingClass {
     ...
     * @param errorCallback Executed if the call fails.
     * @returns The new client.
     */
    async createClient(clientData, errorCallback) {
        try {
            const token = await this.getTokenOrThrow("Only authenticated users can create a client.");
            const response = await this.axiosClient.post(`/client`, clientData, {
                headers: {
